	...
	if($thisMD5 != $prevMD5) {
		...
		setupTable(
			...
			CREATE TABLE IF NOT EXISTS `mapa` ( 
				...
				PRIMARY KEY (`ID`),
				`mapa` VARCHAR(100) NULL
			) CHARSET utf8mb4", [
				"ALTER TABLE mapa ADD `field1` VARCHAR(40)",
				"ALTER TABLE `mapa` CHANGE `field1` `mapa` VARCHAR(40) NULL ",
				" ALTER TABLE `mapa` CHANGE `mapa` `mapa` VARCHAR(100) NULL ",
				"ALTER TABLE mapa ADD `field2` VARCHAR(40)",
				"ALTER TABLE `mapa` CHANGE `field2` `ID` VARCHAR(40) NULL ",
				"ALTER TABLE `mapa` CHANGE `ID` `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT ",
			]
		);
